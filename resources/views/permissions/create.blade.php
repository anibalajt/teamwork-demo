                        ...
                        <div class="card-body mt-2 p-4">
                            <form action="  {{ route('permissions.store') }}  " method="post">
                                ...
                                <div class="pb-4 flex">
                                    ...
                                    <input type="text" id="name" name="name" required maxlength="120" class="flex-1 form-control" aria-required="true" placeholder="enter permission name here">
                                </div>
                            ...
                            <span class="py-4 w-1/12 w-20">
                                    ...
                                    <a href="{{ route('permissions.index')  }}" class="rounded py-4 px-8 bg-red-200 text-center">
                                        Cancel
                                    </a>
                                </div>
                            </form>
