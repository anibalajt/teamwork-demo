                    ...
                    <div class="card-body mt-2 p-4">
                        <form action="  {{ route('users.store') }}  " method="post">
                            ...
                            <div class="pb-4 flex">
                                ...
                                <input type="text" id="name" name="name" required maxlength="128" class="flex-1 form-control" aria-required="true" placeholder="enter your name here">
                            </div>
                            ...
                            <div class="pb-4 flex">
                                ...
                                <input type="email" class="flex-1 form-control" id="email" name="email" aria-required="true" placeholder="enter your email address">
                            </div>
                            ...
                            <div class="pb-4 flex">
                                ...
                                <input type="password"  id="password" name="password" class="flex-1 form-control" placeholder="please enter your password ">
                            </div>
